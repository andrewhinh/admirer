...
class ImageToTextPrintLogger(pl.Callback):
    ...
    def on_test_batch_end(self, trainer, module, output, batch, batch_idx, dataloader_idx):
        self._log_image_text_table(trainer, output, batch, "test/predictions")
    ...
    def _log_image_text_table(self, trainer, output, batch, key):
        ...
        print("Actual: ", actual_sentences)
        print("Generated: ", generated_sentences)
