...
from question_answer.data.emnist import EMNIST
from question_answer.data.util import BaseDataset, convert_strings_to_labels
import question_answer.metadata.emnist_lines2 as metadata
from question_answer.stems.line import LineStem
...
class EMNISTLines2(BaseDataModule):
    ...
    def _generate_data(self, split: str) -> None:
        ...
        from question_answer.data.sentence_generator import SentenceGenerator
